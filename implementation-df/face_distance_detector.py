    ...
    ########################################################################################
        ...
        if not succes_right or not succes_left:                    
            ...
            if not results_right.detections or not results_left.detections:
                ...
                #disparity = tri.find_disparity(center_point_right, center_point_left, frame_right, frame_left, B, f, alpha)
                
                #cv2.putText(frame_right, 'Disparity:' + str(round(disparity,1)), (50,100), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0),3)
                #cv2.putText(frame_left, 'Disparity:' + str(round(disparity,1)), (50,100), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0,255,0),3)
                #print("Disparity: ", str(round(disparity,1)))
