...
img1 = cv.imread('./data/scenes/1/frameL/img1.png', cv.IMREAD_UNCHANGED)
img2 = cv.imread('./data/scenes/1/frameR/img1.png', cv.IMREAD_UNCHANGED)
...
def drawlines(img1src, img2src, lines, pts1src, pts2src):
    ...
    r, c, *_ = img1src.shape
    img1color = img1src  # cv.cvtColor(img1src, cv.COLOR_GRAY2BGR)
    img2color = img2src  # cv.cvtColor(img2src, cv.COLOR_GRAY2BGR)
