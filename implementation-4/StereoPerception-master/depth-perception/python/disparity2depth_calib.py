...
assert os.path.exists("../data/Y/params_py.xml"), os.getcwd()
assert os.path.exists("../data/Y/depth_estimation_params_py.xml"), os.getcwd()

# Reading the mapping values for stereo image rectification
cv_file = cv2.FileStorage("../data/Y/stereo_rectify_maps.xml", cv2.FILE_STORAGE_READ)
...
min_dist = 30  # min distance the stereo setup can measure (in cm)
...
cv_file = cv2.FileStorage("../data/Y/depth_estimation_params_py.xml", cv2.FILE_STORAGE_READ)
...
print('Shape of the array is: ', np.shape(value_pairs))
print('Dimension of the array is: ', len(np.shape(value_pairs)))
print(value_pairs[0])
print(value_pairs[1])
z = value_pairs[:, 0]
disp = value_pairs[:, 1]
...
cv_file = cv2.FileStorage("../data/Y/depth_estimation_params_updated_py.xml", cv2.FILE_STORAGE_WRITE)
